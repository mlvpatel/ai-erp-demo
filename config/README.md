...
- `pilot-readiness.json`: truthful synthetic service-pilot evidence map. It
  keeps human UAT, legal, deployment, recovery, capacity, and owner gates
  pending until private evidence and accountable approvals exist.
